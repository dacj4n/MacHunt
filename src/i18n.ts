export const I18N = {
  zh: {
    ...
    menuTrash: "移到废纸篓",
    wildcardMode: "通配符",
    wildcardHint: "通配符匹配：* 任意单层、** 任意层级、? 单个字符、{a,b} 匹配其中之一（不支持正则）",
    fuzzyEnabled: "模糊",
    caseSensitive: "区分大小写",
    timeFilter: "时间",
    timeAll: "所有时间",
    ...
    advancedTitle: "高级功能",
    advancedDesc: "索引维护、监听目录、排除规则等进阶配置。",
    ...
    themeSystemTitle: "跟随系统",
    themeSystemDesc: "随 macOS 外观自动切换。",
    themeCurrent: "当前生效主题",
    languageTitle: "语言",
    languageZhTitle: "中文",
    ...
    startupShowTrayIcon: "显示菜单栏图标",
    startupShowTrayIconDesc: "开启后，菜单栏会显示 MacHunt 图标，支持右键菜单快速操作。",
    ...
    loggingTitle: "诊断日志",
    loggingDesc: "记录文件监听收到的原始事件，用于排查「文件没有被索引」这类问题。默认关闭，不产生任何日志文件。",
    loggingEnableTitle: "启用诊断日志",
    loggingEnableDesc: "开启后立即生效，关闭即停止记录。日志位于 ~/Library/Caches/MacHunt/logs/。",
    loggingScopePlaceholder: "留空则记录全部；也可填路径前缀限制范围",
    loggingScopeHint: "最多保留 10 个日志文件，单文件上限 32 MiB，不会无限增长。",
    loggingSaving: "正在保存日志设置...",
    loggingSaved: "日志设置已保存",
    loggingSaveFailed: "保存日志设置失败",
  ...
  en: {
    ...
    wildcardHint: "Wildcard matching: * one level, ** any level, ? one character, {a,b} either (regular expressions are not supported)",
    fuzzyEnabled: "Fuzzy",
    ...
    advancedDesc: "Index management, watch directories, exclusion rules, and more.",
    ...
    themeSystemDesc: "Match the macOS appearance.",
    ...
    startupShowTrayIcon: "Show Menu Bar Icon",
    startupShowTrayIconDesc: "When enabled, MacHunt icon appears in the menu bar with a right-click menu for quick actions.",
    ...
    loggingTitle: "Diagnostics log",
    loggingDesc: "Records the raw events the file watcher receives, for tracing problems such as files never appearing in the index. Off by default, and produces no log files at all.",
    loggingEnableTitle: "Enable diagnostics log",
    loggingEnableDesc: "Applies immediately; turning it off stops recording. Logs live in ~/Library/Caches/MacHunt/logs/.",
    loggingScopePlaceholder: "Empty records everything, or enter a path prefix to narrow it",
    loggingScopeHint: "Keeps at most 10 log files, 32 MiB each, so it cannot grow without bound.",
    loggingSaving: "Saving log settings...",
    loggingSaved: "Log settings saved",
    loggingSaveFailed: "Failed to save log settings",
